...
function Home(props) {
  return (
    <div id="app" class="home bg-dark text-secondary px-4 py-5 text-center">
      ...
      <div class="py-3">
        <h1 class="display-5 fw-bold text-white">🍔 Mood4Food</h1>
        <div class="col-lg-6 mx-auto">
          <p class="fs-5 mb-4">Find food recommendations from a machine learning model!</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="mt-2">
          ...
          <input type="range" class="form-range w-25" id="customRange1" onChange={(e) => {props.set.setTemperature(e.target.value)}} min="30" max="100" step="1"/>
        </div>
        ...
        <div class="mt-2 text-center">
          <div><label for="customRange1" class="form-label text-white">Preferred Cuisine</label></div>
